...
namespace AuthServer.Service.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public AuthenticationService(IOptions<List<Client>> clients, ITokenService tokenService, UserManager<UserApp> userManager, IUnitOfWork unitOfWork, IGenericRepository<UserRefreshToken> refreshTokenRepository)
        {
        ...
        public async Task<Response<TokenDto>> CreateTokenAsync(LoginDto loginDto)
        {
            ...
            var userRefreshToken = await _refreshTokenRepository.Where(urt => urt.UserId == user.Id).FirstOrDefaultAsync();
        ...
        {
            var client = _clients.SingleOrDefault(c=>c.Id==clientLoginDto.ClientId && c.Secret==clientLoginDto.ClientSecret);
        ...
        {
            var existRefreshToken = await _refreshTokenRepository.Where(r=>r.Code==refreshToken).FirstOrDefaultAsync();
            ...
            existRefreshToken.Code = token.RefreshToken.ToString();
